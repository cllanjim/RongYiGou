...
- (void)showInView:(UIView *) view
{
    ...
    self.backgroundColor = [UIColor colorWithRed:235/255.0 green:235/255. blue:235/255. alpha:0.7];
    
    [view addSubview:self];
    
    [UIView animateWithDuration:0.3 animations:^{
        self.frame = CGRectMake(0, view.frame.size.height/3, view.frame.size.width, self.frame.size.height);
    }];
